...
type ListAlimentoScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
  "ListAlimentos"
>;
type ListAlimentoScreenRouteProp = RouteProp<
  RootStackParamList,
  "ListAlimentos"
>;
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.container}>
        ...
        >
          <Picker.Item label="Todas as Categorias" value="todascategorias" style={style.pickerText}/>
